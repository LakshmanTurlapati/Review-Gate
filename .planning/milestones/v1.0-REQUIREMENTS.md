...
For future milestone requirements, start a new `.planning/REQUIREMENTS.md` via `$gsd-new-milestone`.
...
- [x] **INST-01**: User can run the macOS/Linux installer without shell parsing failures from dependency version specifiers.
- [x] **INST-02**: User can install Review Gate on default macOS without requiring GNU `timeout` or manual script patching.
